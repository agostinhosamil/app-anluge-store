export type ObjectFullMergeProp<ObjectsType extends object = any> = {
...
export const objectFullMerge = <ObjectsType extends object = any>(
  firstObject: ObjectsType,
  ...objects: Array<Partial<ObjectsType>>
): ObjectsType => {
    ...
    for (const key of objectKeys) {
      ...
      if (currentValue instanceof Array) {
        mergedObjects[objectKey] = [
          ...
          ...(objectKeyValue instanceof Array ? objectKeyValue : [])
      ...
      if (
        typeof mergedObjects[objectKey] === 'object' &&
        mergedObjects[objectKey]
      ) {
        mergedObjects[objectKey] = objectFullMerge<ObjectsType>(
