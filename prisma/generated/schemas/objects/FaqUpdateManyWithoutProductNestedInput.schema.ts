...
const Schema: z.ZodType<Prisma.FaqUpdateManyWithoutProductNestedInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => FaqUncheckedCreateWithoutProductInputObjectSchema).array()
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => FaqCreateOrConnectWithoutProductInputObjectSchema),
        z.lazy(() => FaqCreateOrConnectWithoutProductInputObjectSchema).array()
      ])
      .optional(),
    upsert: z
      .union([
...
export const FaqUpdateManyWithoutProductNestedInputObjectSchema = Schema
