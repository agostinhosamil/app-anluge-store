...
const Schema: z.ZodType<Prisma.FaqUncheckedCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const FaqUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema
