...
const Schema: z.ZodType<Prisma.FavoriteCreateNestedManyWithoutProductInput> = z
  .object({
    create: z
      .union([
...
export const FavoriteCreateNestedManyWithoutProductInputObjectSchema = Schema
