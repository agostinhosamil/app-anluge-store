...
const Schema: z.ZodType<Prisma.MediaUpdateManyWithoutProductNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => MediaUpsertWithWhereUniqueWithoutProductInputObjectSchema),
        z
          .lazy(() => MediaUpsertWithWhereUniqueWithoutProductInputObjectSchema)
          .array()
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => MediaUpdateWithWhereUniqueWithoutProductInputObjectSchema),
        z
          .lazy(() => MediaUpdateWithWhereUniqueWithoutProductInputObjectSchema)
          .array()
      ])
      .optional(),
    updateMany: z
...
export const MediaUpdateManyWithoutProductNestedInputObjectSchema = Schema
