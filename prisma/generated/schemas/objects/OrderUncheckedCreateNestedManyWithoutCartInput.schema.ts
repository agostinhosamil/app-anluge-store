...
const Schema: z.ZodType<Prisma.OrderUncheckedCreateNestedManyWithoutCartInput> =
  z
    .object({
      create: z
        .union([
...
export const OrderUncheckedCreateNestedManyWithoutCartInputObjectSchema = Schema
