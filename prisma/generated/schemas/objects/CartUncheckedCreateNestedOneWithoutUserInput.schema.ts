...
const Schema: z.ZodType<Prisma.CartUncheckedCreateNestedOneWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const CartUncheckedCreateNestedOneWithoutUserInputObjectSchema = Schema
