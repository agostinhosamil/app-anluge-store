...
import { OrderCreateManyProductInputEnvelopeObjectSchema } from './OrderCreateManyProductInputEnvelope.schema'
  ...
  z
    .object({
      ...
      upsert: z
        ...
        .optional(),
      createMany: z
        .lazy(() => OrderCreateManyProductInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
