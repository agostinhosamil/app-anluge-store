...
const Schema: z.ZodType<Prisma.RateUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const RateUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema
