...
const Schema: z.ZodType<Prisma.OrderUncheckedUpdateManyWithoutCartNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const OrderUncheckedUpdateManyWithoutCartNestedInputObjectSchema = Schema
