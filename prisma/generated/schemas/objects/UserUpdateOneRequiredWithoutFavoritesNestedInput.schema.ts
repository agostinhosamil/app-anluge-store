...
const Schema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutFavoritesNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => UserCreateOrConnectWithoutFavoritesInputObjectSchema)
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutFavoritesInputObjectSchema)
        .optional(),
...
export const UserUpdateOneRequiredWithoutFavoritesNestedInputObjectSchema =
  Schema
