...
const Schema: z.ZodType<Prisma.FavoriteUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FavoriteUncheckedUpdateManyWithoutProductNestedInputObjectSchema =
  Schema
