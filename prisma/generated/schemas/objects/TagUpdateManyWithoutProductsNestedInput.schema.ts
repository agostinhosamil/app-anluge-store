...
const Schema: z.ZodType<Prisma.TagUpdateManyWithoutProductsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => TagUpsertWithWhereUniqueWithoutProductsInputObjectSchema),
        z
          .lazy(() => TagUpsertWithWhereUniqueWithoutProductsInputObjectSchema)
          .array()
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => TagUpdateWithWhereUniqueWithoutProductsInputObjectSchema),
        z
          .lazy(() => TagUpdateWithWhereUniqueWithoutProductsInputObjectSchema)
          .array()
      ])
      .optional(),
    updateMany: z
...
export const TagUpdateManyWithoutProductsNestedInputObjectSchema = Schema
