...
const Schema: z.ZodType<Prisma.FavoriteUpdateManyWithWhereWithoutProductInput> =
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(
          () => FavoriteUncheckedUpdateManyWithoutFavoritesInputObjectSchema
        )
      ])
    })
    .strict()

export const FavoriteUpdateManyWithWhereWithoutProductInputObjectSchema = Schema
