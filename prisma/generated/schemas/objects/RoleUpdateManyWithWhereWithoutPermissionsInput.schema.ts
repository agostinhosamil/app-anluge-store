...
const Schema: z.ZodType<Prisma.RoleUpdateManyWithWhereWithoutPermissionsInput> =
  z
    .object({
...
export const RoleUpdateManyWithWhereWithoutPermissionsInputObjectSchema = Schema
