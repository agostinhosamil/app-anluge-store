...
const Schema: z.ZodType<Prisma.UserTokenUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const UserTokenUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema
