...
const Schema: z.ZodType<Prisma.MediaUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const MediaUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema
