...
const Schema: z.ZodType<Prisma.RoleUpdateManyWithoutPermissionsNestedInput> = z
  .object({
    create: z
      .union([
...
export const RoleUpdateManyWithoutPermissionsNestedInputObjectSchema = Schema
