...
import { TagUncheckedUpdateManyWithoutProductsNestedInputObjectSchema } from './TagUncheckedUpdateManyWithoutProductsNestedInput.schema'
...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutFavoritesInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    medias: z
      ...
      .optional(),
    tags: z
      .lazy(() => TagUncheckedUpdateManyWithoutProductsNestedInputObjectSchema)
      .optional(),
    faqs: z
...
export const ProductUncheckedUpdateWithoutFavoritesInputObjectSchema = Schema
