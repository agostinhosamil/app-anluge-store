...
const Schema: z.ZodType<Prisma.UserTokenUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => UserTokenUpdateManyWithWhereWithoutUserInputObjectSchema
          ),
          z
            .lazy(
              () => UserTokenUpdateManyWithWhereWithoutUserInputObjectSchema
...
export const UserTokenUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema
