...
const Schema: z.ZodType<Prisma.FavoriteUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => FavoriteUncheckedCreateWithoutUserInputObjectSchema)
            .array()
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => FavoriteCreateOrConnectWithoutUserInputObjectSchema)
            .array()
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(
            () => FavoriteUpsertWithWhereUniqueWithoutUserInputObjectSchema
          ),
          z
            .lazy(
              () => FavoriteUpsertWithWhereUniqueWithoutUserInputObjectSchema
        ...
        .optional(),
      createMany: z
        .lazy(() => FavoriteCreateManyUserInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () => FavoriteUpdateWithWhereUniqueWithoutUserInputObjectSchema
          ),
          z
            .lazy(
              () => FavoriteUpdateWithWhereUniqueWithoutUserInputObjectSchema
      ...
      updateMany: z
        .union([
          ...
          z
            .lazy(() => FavoriteUpdateManyWithWhereWithoutUserInputObjectSchema)
            .array()
        ])
        .optional(),
      deleteMany: z
...
export const FavoriteUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema
