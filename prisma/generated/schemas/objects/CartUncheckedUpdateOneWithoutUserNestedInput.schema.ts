...
const Schema: z.ZodType<Prisma.CartUncheckedUpdateOneWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const CartUncheckedUpdateOneWithoutUserNestedInputObjectSchema = Schema
