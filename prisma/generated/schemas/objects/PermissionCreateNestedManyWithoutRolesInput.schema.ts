...
const Schema: z.ZodType<Prisma.PermissionCreateNestedManyWithoutRolesInput> = z
  .object({
    create: z
      .union([
...
export const PermissionCreateNestedManyWithoutRolesInputObjectSchema = Schema
