...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutTagsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ProductUpsertWithWhereUniqueWithoutTagsInputObjectSchema
          ),
          z
            .lazy(
              () => ProductUpsertWithWhereUniqueWithoutTagsInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => ProductUpdateWithWhereUniqueWithoutTagsInputObjectSchema
          ),
          z
            .lazy(
              () => ProductUpdateWithWhereUniqueWithoutTagsInputObjectSchema
...
export const ProductUncheckedUpdateManyWithoutTagsNestedInputObjectSchema =
  Schema
