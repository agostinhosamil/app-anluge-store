...
const Schema: z.ZodType<Prisma.PermissionUpdateManyWithoutRolesNestedInput> = z
  .object({
    create: z
      .union([
...
export const PermissionUpdateManyWithoutRolesNestedInputObjectSchema = Schema
