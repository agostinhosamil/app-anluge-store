...
const Schema: z.ZodType<Prisma.RoleCreateNestedManyWithoutPermissionsInput> = z
  .object({
    create: z
      .union([
...
export const RoleCreateNestedManyWithoutPermissionsInputObjectSchema = Schema
